...
export class EditPostComponent implements OnInit {
  ...
  model: postDTO = {
    ...
    image: 'https://images2.minutemediacdn.com/image/upload/c_crop,w_3147,h_1770,x_0,y_178/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/images/GettyImages/mmsport/12up_es_international_web/01gemrmc3vjcsdvzdvhc.jpg',
    postDate: new Date(),
    statusId: 3
  };
